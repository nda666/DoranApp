...
public partial class ByKotaForm : Form
{
    public List<LaporanTransaksiPenjualanGroupKotaDto> _data = new List<LaporanTransaksiPenjualanGroupKotaDto>();
    private double Total = 0;

    public ByKotaForm(List<LaporanTransaksiPenjualanGroupKotaDto> data)
    {
        InitializeComponent();
        _data = data;
    ...
    private void ByKotaForm_KeyDown(object sender, KeyEventArgs e)
    {
